package com.gac.zookeeper.zookeeperdemp.curator.discovery;


import com.gac.zookeeper.zookeeperdemp.curator.CuratorStandaloneBase;
...
public class DiscoveryTest extends CuratorStandaloneBase {
    ...
    public void testRegister() throws Exception {
        ...
        JsonInstanceSerializer<InstanceInfo> serializer = new JsonInstanceSerializer<>(InstanceInfo.class);
